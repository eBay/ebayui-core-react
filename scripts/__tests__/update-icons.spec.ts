...
describe('update-icons', () => {
    ...
    describe('getIconKeys()', () => {
        it('should extract icon name from SVG symbols', () => {
            const expected = {
                iconKeys: ['add', 'programBadgeAuthenticityGuaranteed', 'socialMessenger', 'socialWhatsapp'],
                programKeys: ['authenticityGuaranteed']
            }
