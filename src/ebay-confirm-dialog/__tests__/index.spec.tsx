...
describe('<EbayConfirmDialog>', () => {
    describe('default', ()=>{
        ...
        it('should have confirm button', () => {
            expect(wrapper.container.querySelector('#confirm-dialog-confirm')).toBeInTheDocument()
        })
    })
    describe('no footer', ()=>{
        it('should not have confirm button', () => {
            const  wrapper = render( <EbayConfirmDialog open><p>test</p></EbayConfirmDialog>  )
            expect(wrapper.container.querySelector('#confirm-dialog-confirm')).not.toBeInTheDocument()
        })
    })
})
